...
*** Approach can be sped by pre-sorting nums. Then at any point in the iteration, 
if nums[ix]>target, then it or any elements after it cannot be part of solution; return back.
'''
class Solution:
